...
################################################################################
# Script: list_water_sport_locations.sh
# Description: Extract unique water-sport activity locations and show counts.
#              Use this to identify which coordinates to relabel.
#
# Usage:
#   ./list_water_sport_locations.sh ACTIVITIES_DIR
#
# Workflow:
...
#   4. Provide the list back to update the analyze_water_sports.sh mappings
#
################################################################################
...
echo "Unique Water-Sport Activity Locations"
echo "====================================="
echo ""
